...
exclude_patterns = ['docs', 'Thumbs.db', '.DS_Store', 'tests']
...
htmlhelp_basename = '{{ cookiecutter.role_name }}doc'
...
latex_documents = [
    (master_doc, '{{ cookiecutter.role_name }}.tex', '{{ cookiecutter.role_name }} Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, '{{ cookiecutter.role_name }}', '{{ cookiecutter.description }}',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '{{ cookiecutter.role_name }}', '{{ cookiecutter.role_name }} Documentation',
     author, '{{ cookiecutter.role_name }}', '{{ cookiecutter.description }}',
     'Miscellaneous'),
]
